...
class AboutMoreStringPractice(Koan):
	def test_isVowel(self):
		...
		This method takes in a character and returns true if the character is 
	...
	def test_positionOfFirstVowel(self):
		...
		"""
		This is intended to make feel more comfortable with indexing in strings
		________
		ACTIVITY:
		________

		This method takes in a word and returns the index position of the first
